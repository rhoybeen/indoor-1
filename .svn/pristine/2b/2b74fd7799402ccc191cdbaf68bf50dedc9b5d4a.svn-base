...
public class ScanService extends Service {
	...
	public void onDestroy() {
		...
		if (showList != null && showList.size() > 0) {
			...
			Toast.makeText(this, "巡检总共进行了 " + min + " min, 成功记录", 3000).show();
		} else {
	...
	class MyPhonestateListener extends PhoneStateListener {
		...
		public void onServiceStateChanged(ServiceState serviceState) {
			...
			Log.i("--onServiceStateChanged--", "current voice state"
		...
		public void onMessageWaitingIndicatorChanged(boolean mwi) {
			...
			Log.i("--onMessageWaitingIndicatorChanged--",
		...
		public void onCallForwardingIndicatorChanged(boolean cfi) {
			...
			Log.i("--onCallForwardingIndicatorChanged--",
		...
		public void onCellLocationChanged(CellLocation location) {
			...
			Log.i("--onCellLocationChanged--", " current celllocation cid  "
					+ ((GsmCellLocation) location).getCid());
			Log.i("--onCellLocationChanged--", " neighbor cell number "
		...
		public void onCallStateChanged(int state, String incomingNumber) {
			...
			Log.i("--onCallStateChanged--", " state " + state
		...
		public void onDataConnectionStateChanged(int state) {
			...
			Log.i("--onDataConnectionStateChanged--", " state " + state);
		...
		public void onDataActivity(int direction) {
			...
			Log.i("--onDataActivity--", " direction " + direction);
		}

		@Override
		public void onCellInfoChanged(List<CellInfo> cellInfo) {
			super.onCellInfoChanged(cellInfo);
			Log.i("--onCellInfoChanged--", " cellInfo size "
